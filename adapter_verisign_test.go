...
const testStringVerisignNoWhois = `Whois Server Version 2.0
...
func TestVerisignParser(t *testing.T) {
	...
	*/
	...
	if record.Whois != "whois.verisign-grs.com" {
...
func TestVerisignParserNoWhois(t *testing.T) {
	r := NewResponse("google.com", "whois.verisign-grs.com")
	r.Charset = "utf-8"
	r.Body = []byte(testStringVerisignNoWhois)
